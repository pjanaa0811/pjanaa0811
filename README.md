...
- Theme: tokyonight / tokyonight-duo througho
ut.
...
pjanaa0811@gmail.com 7010951280 Chennai 600044
PERSONAL SUMMARY
Full Stack Developer with hands-on experience in developing scalable web applications using Python, Django,
React, and Node.js. Possess basic knowledge of C programming and currently building a strong foundation in
data structures. Familiar with modern web technologies and capable of developing user-centric applications with
effective frontend and backend integration through internships and academic projects. Seeking to apply and
expand technical skills while contributing to innovative and impactful software solutions.
EXPERIENCE
Web Developer Intern, Prodigy Infotech
•Designed user-friendly interfaces and implemented efficient front-end solutions to
improve overall user experience.
•Developed applications including calculator tools, Tic-Tac-Toe games, online stores,
and personal portfolio sites to enhance user engagement.
12/2025 – 01/2026
•Wrote maintainable code to ensure long-term usability and facilitate future updates.
Web Designer Intern, Technohacks
•Specialized in front-end development and UI design, contributing to successful
delivery of multiple projects.
•Developed portfolio websites, e-commerce applications, to-do lists, and volunteer
management systems.
08/2025 – 09/2025
•Designed visually appealing web interfaces to enhance user experience.
•Applied practical experience at Technohacks to elevate overall design quality across
various applications.
Full Stack Developer Intern, Retech Solutions Pvt.Ltd
•Completed internship in Full Stack Development (Python) at Retech Solutions Pvt.
Ltd., enhancing skills in full stack technologies.
•Developed Django-based platform for volunteer management and engagement,
streamlining user interactions and strengthening community involvement.
06/2025 – 07/2025
Chennai
EDUCATION
Btech: Information technology, Agni College of Technology
•CGPA: 7.94
04/2027
Chennai
SKILLS
